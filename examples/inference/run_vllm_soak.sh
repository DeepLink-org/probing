...
#   DURATION_SEC=120 ./examples/inference/run_vllm_soak.sh
#   VLLM_MODEL=facebook/opt-125m ./examples/inference/run_vllm_soak.sh
#
...
COMMON_ARGS=(
  examples/inference/vllm_offline_soak.py
  --model "$VLLM_MODEL"
