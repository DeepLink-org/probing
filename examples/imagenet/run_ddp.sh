...
#   DURATION_SEC=60 ./examples/imagenet/run_ddp.sh
#   NPROC=2 DIST_BACKEND=nccl ./examples/imagenet/run_ddp.sh   # needs >=2 GPUs
#
...
COMMON_ARGS=(
  examples/imagenet/imagenet_with_span.py
  /tmp/imagenet-dummy
  --dummy
  --no-validate
  --arch resnet18
