...
#   DURATION_SEC=120 ./examples/megatron/run_soak.sh
#   NPROC=1 TP_SIZE=1 ./examples/megatron/run_soak.sh
#
...
if [[ "$_os" != "Linux" ]]; then
  ...
  echo "  On macOS use ./examples/inference/run_vllm_soak.sh for a real-framework probing demo." >&2
